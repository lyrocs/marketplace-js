        ...
        <div class="flex grow flex-col p-4">
            ...
            <div class="flex gap-4">
                ...
                <p class="text-sm flex gap-1">
                    Specs:
                <ul v-for="spec in product.specs" :key="spec.id" class="flex gap-1">
                    <li>{{ spec.value }}</li>
                </ul>
                </p>
            </div>
            <div class="flex gap-4 border-t mt-2">
                <div v-for="shop in product.shops" :key="shop.id" class="mt- flex flex-col items-center gap-2  py-2">
